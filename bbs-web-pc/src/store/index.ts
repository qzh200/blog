...
const store = createStore<TypeRootState>({
    ...
    mutations: {
        ...
        setAiAssistantParameter(state: TypeRootState, value:any) {
            state.aiAssistantParameter = value;
        },
        setDefaultLanguage(state: TypeRootState, value:any) {
            state.defaultLanguage = value;
        },
        setLanguageSwitching(state: TypeRootState, value:any) {
            state.languageSwitching = value;
        },
        setCurrentLanguage(state: TypeRootState, value:any) {
