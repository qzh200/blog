...
<template>
    <div class="footer">
        ...
        <!-- 版权所有 -->
        <div class="copyright">{{t('footer.10')}}<em>&copy;diyhi.com</em>
            <!-- 联系我们 -->
            <router-link tag="a" :to="'/feedback'" target="_blank">{{t('footer.20')}}</router-link>
        </div>	
    </div>
</template>
...
.footer { 
    ...
    .message { 
        width: 990px; margin: 0 auto; height: 18px; font-size: 0; line-height: 0; 
        text-align: center;
        a, em {  
