...
<template>
    <!-- 页头 -->
    <Header :shrink="shrinkRef" @floatWindow="receive_floatWindow"/>
            ...
            <div class="helpDetailModule">
                ...
                <div class="right"> 
                    ...
                    <div class="help-wrap">
                        ...
                        <!--title="没有找到相关记录"-->
                        <el-result v-if="state.loading == false && (state.help == null || Object.keys(state.help).length == 0)" icon="info" :title="t('helpDetail.10')"></el-result>
                    </div> 
