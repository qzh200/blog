...
<script lang="ts" setup>
    ...
    const { meta } = useMeta(
        computed(() => ({ 
            title:  t('membershipCardList.50')+' - ' + store.state.title,//会员卡列表
            meta: [
                {
                    name: 'keywords',
                    content: t('membershipCardList.50')+' - ' + store.state.title//会员卡列表
                },{
                    name: "description",
                    content: t('membershipCardList.50')+' - ' + store.state.title//会员卡列表
                }
