        ...
        <div class="data-form label-width-blank" >
            <el-form label-width="auto"  @submit.native.prevent>
                ...
                <el-form-item label="接口产品">
                    <span v-if="state.interfaceProduct == 1">阿里云短信</span>
                </el-form-item>
                <el-form-item label="用户密钥Id(accessKeyId)" v-if="state.interfaceProduct ==1" :required="true" :error="error.alidayu_accessKeyId">
                    ...
                    <div class="form-help" >
                        <a href="/admin/backstage/images/help/alidayu_accessKey.jpg" target="_blank">获取方法演示</a>
                    </div>
                </el-form-item>
                ...
                <div class="data-view" v-for="(sendService,index) in state.sendServiceList">
                    ...
                    <el-form-item label="国内短信签名" v-if="sendService.interfaceProduct == 1 && state.interfaceProduct ==1" :error="error.alidayu_signName.get(sendService.interfaceProduct+'_'+sendService.serviceId)">
                    ...
                    <el-form-item label="国内短信模板代码" v-if="sendService.interfaceProduct == 1 && state.interfaceProduct ==1" :error="error.alidayu_templateCode.get(sendService.interfaceProduct+'_'+sendService.serviceId)">
                    ...
                    <el-form-item label="国际短信签名" v-if="sendService.interfaceProduct == 1 && state.interfaceProduct ==1" :error="error.alidayu_internationalSignName.get(sendService.interfaceProduct+'_'+sendService.serviceId)">
                        <el-col :span="18"><el-input v-model.trim="state.alidayu_internationalSignName[index]" maxlength="80" :clearable="true" show-word-limit></el-input></el-col>
                        <div class="form-help" >阿里云管理控制台审核通过的短信签名</div>
                    </el-form-item>
                    <el-form-item label="国际模板代码" v-if="sendService.interfaceProduct == 1 && state.interfaceProduct ==1" :error="error.alidayu_internationalTemplateCode.get(sendService.interfaceProduct+'_'+sendService.serviceId)">
                        <el-col :span="18"><el-input v-model.trim="state.alidayu_internationalTemplateCode[index]" maxlength="80" :clearable="true" show-word-limit></el-input></el-col>
                        <div class="form-help" >例如：SMS_1000000</div>
                    </el-form-item>
...
<script lang="ts" setup>
    ...
    const state = reactive({
        ...
        alidayu_internationalSignName:[] as Array<string>,
        alidayu_internationalTemplateCode:[] as Array<string>,
			    			...
			    			if(key == "sendServiceList"){
			    				...
			    				if(sendServiceList != null && sendServiceList.length >0){
			    					for(let i=0; i<sendServiceList.length; i++){
                                        ...
                                        state.alidayu_internationalSignName.push(sendService.alidayu_internationalSignName);
			    						state.alidayu_internationalTemplateCode.push(sendService.alidayu_internationalTemplateCode);
    ...
    const submitForm = () => {
        ...
        if(state.sendServiceList != null && state.sendServiceList.length >0){
            for(let i=0; i<state.sendServiceList.length; i++){
                ...
                if(state.alidayu_signName[i] != null){
                    formData.append('alidayu_signName_'+sendService.interfaceProduct+"_"+sendService.serviceId, state.alidayu_signName[i]);
                }
                if(state.alidayu_templateCode[i] != null){
                    formData.append('alidayu_templateCode_'+sendService.interfaceProduct+"_"+sendService.serviceId, state.alidayu_templateCode[i]);
                }
                if(state.alidayu_internationalSignName[i] != null){
                    formData.append('alidayu_internationalSignName_'+sendService.interfaceProduct+"_"+sendService.serviceId, state.alidayu_internationalSignName[i]);
                }
                if(state.alidayu_internationalTemplateCode[i] != null){
                    formData.append('alidayu_internationalTemplateCode_'+sendService.interfaceProduct+"_"+sendService.serviceId, state.alidayu_internationalTemplateCode[i]);
                }
            }
        }
