                                    ...
                                    <el-row v-if="state.specification.stockStatus[scope.$index] > 0">
                                        <div class="singleRowTable">
                                            ...
                                            <div class="leftCell" style="margin-left: 20px;width: 100px;">
                                                <el-select v-model="state.specification.symbol[scope.$index]" size="large" no-match-text="还没有符号" placeholder="选择符号">
                                ...
                                <el-row :gutter="30">
                                    ...
                                    <el-col :span="4">
                                        <el-form-item :error="error.unit.get(scope.$index)" style="margin-left: -20px;">
                                            <el-select v-model="state.specification.unit[scope.$index]" size="large" no-match-text="还没有单位" placeholder="选择单位">
