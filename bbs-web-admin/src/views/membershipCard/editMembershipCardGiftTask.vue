        ...
        <div class="data-form label-width-blank membershipCardGiftTaskModule" >
            <el-form label-width="auto"  @submit.native.prevent>
                ...
                <el-form-item label="时长" :required="true">
                    <el-form :inline="true" @submit.native.prevent style="position: relative; top:-12px;">
                        <el-row>
                            <el-col :span="12">
                            ...
                            <el-col :span="12">
                                <el-form-item :error="error.unit">
                                    <el-select v-model="state.unit" size="large" class="custom-select-width" no-match-text="还没有单位" placeholder="选择单位" style="margin-left: -20px; width: 120px;">
