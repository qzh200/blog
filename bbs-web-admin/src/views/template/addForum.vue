        ...
        <div class="data-form label-width-blank forumModule" >
            <el-form label-width="auto"  @submit.native.prevent>
                <el-form-item label="版块类型" :required="true" :error="error.forumType">
                    <el-select v-model="state.forumType" size="large" class="custom-select-width" @change="selectedForumType" placeholder="选择类型">
                        <el-option v-for="item in state.forumTypeOptions" :key="item.value" :label="item.label" :value="item.value"></el-option>
                    </el-select>
                    <el-select class="placeholder custom-select-width" v-model="state.forumChildType" size="large" placeholder="选择子类型">
                ...
                <el-form-item label="版块模板" :required="true" :error="error.module">
                    <el-select v-model="state.module" size="large" @change="selectedModule" placeholder="选择模板" style="width: 50%">
                ...
                <div v-if="state.forumType == '问答' && state.forumChildType == '问题列表' && state.displayType == '分页'">
                    <el-form-item label="选择标签" :error="error.page_Forum_QuestionRelated_Question.page_question_tagId">
                        <el-select ref="page_question_tag_ref" size="large" class="custom-select-width" v-model="state.page_Forum_QuestionRelated_Question.tagIdGroup" v-show="state.page_Forum_QuestionRelated_Question.page_question_tag_transferPrameter == false" @click="loadQuestionTag" multiple placeholder="请选择">
