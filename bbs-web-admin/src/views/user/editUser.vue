        ...
        <div class="data-form label-width-blank" >
            <el-form label-width="auto"  @submit.native.prevent>
                ...
                <el-form-item label="手机" :required="state.type == 10? false :true" :error="error.mobile" >
                    <el-col :span="12"><el-input v-model.trim="state.mobile" maxlength="18" :clearable="true" show-word-limit></el-input></el-col>
                ...
                <div v-for="(userCustom,index) in state.userCustomList" class="customForm">
                    ...
                    <el-form-item :label="userCustom.name" :required="userCustom.required" :error="error.userCustom.get('userCustom_'+userCustom.id)" v-if="userCustom.chooseType ==4">
                        <el-select v-model="state.userBoundField[index]" size="large" class="custom-select-width" :multiple="userCustom.multiple" placeholder="请选择">
