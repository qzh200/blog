        ...
        <div class="data-form label-width-blank" >
            <el-form label-width="auto"  @submit.native.prevent>
                ...
                <el-form-item label="排序" :required="true" :error="error.sort">
                    <el-input-number v-model="state.sort" controls-position="right"  :min="1" :max="99999999"></el-input-number>
                ...
                <el-form-item label="选择类型" :required="true" :error="error.chooseType" >
                    <el-select v-model="state.chooseType" size="large" class="custom-select-width" no-match-text="还没有类型" placeholder="选择类型" disabled>
                ...
                <el-form-item label="字段值过滤" :error="error.fieldFilter" v-if="state.chooseType==1">
                    <el-select v-model="state.fieldFilter" size="large" class="custom-select-width" no-match-text="还没有内容" placeholder="选择字段值过滤">
