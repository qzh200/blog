                    ...
                    <div class="main">
                        ...
                        <div class="replyList" v-if="comment.replyList.length >0">
                            ...
                            <ul class="timeline box">
                                ...
                                <li class="timeline-item replyItem-container" v-for="(reply,index2) in comment.replyList" :key="reply.id"  :replyId="reply.id" :ref="handleReplyNodes" v-show="state.replyExpandOrShrink.get(comment.id) || (state.replyExpandOrShrink.get(comment.id) == false && index2 <state.viewNumber)">
