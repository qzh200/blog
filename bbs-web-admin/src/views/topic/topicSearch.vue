        ...
        <div class="search">
            <el-form :inline="true" label-width="auto" @keyup.enter.native="submitForm">
                ...
                <el-form-item :error="error.tagId">
                    <el-select v-model="state.tagIdGroup" size="large" class="custom-select-width"  @click="queryTagList" @change="selectedTag" multiple  no-match-text="还没有标签" placeholder="选择标签">
