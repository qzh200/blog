...
const routes = [
    {path : '/admin/control/manage/index',component: () => import('@/views/index.vue'),
        children: [//嵌套一级子路由
            ...
            {path : '/admin/control/membershipCardGiftTask/manage/membershipCardGiftItemList',component : () => import('@/views/membershipCard/membershipCardGiftItemList.vue'), name:'membershipCardGiftItemList',meta: {parent:'2-200200-3',title:'获赠用户列表',cacheNumber:'0'}},//查询会员卡赠送项(获赠用户)
